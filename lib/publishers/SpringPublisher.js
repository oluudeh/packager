...
class SpringPublisher {
    static publish(artifact, group, version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pom = yield FileService_1.FileService.read(Constants_1.default.DEPLOYMENT_SPRING + '/pom.xml');
            pom = pom
                .replace('</project>', Constants_1.default.POM_DISTRIBUTION(github_1.default.context.repo.owner, github_1.default.context.repo.repo))
    ...
    static createSettingsXML() {
        return __awaiter(this, void 0, void 0, function* () {
            yield FileService_1.FileService.write(Constants_1.default.DEPLOYMENT_SPRING + '/settings.xml', Constants_1.default.SETTINGS_XML(github_1.default.context.repo.owner, Constants_1.default.DEPLOY_TOKEN));
        });
    }
    static publishCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, execute_1.execute)(`ls -la`).then(console.log);
            yield (0, execute_1.execute)(`cd ${Constants_1.default.DEPLOYMENT_SPRING}; ls -la`).then(console.log);
